...
public class IconAdapter extends RecyclerView.Adapter<IconAdapter.ViewHolder> {
    ...
    public IconAdapter(Context context, ArrayList<String> listTheme) {
    ...
    @NonNull
    @Override
    public IconAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater layoutInflater = LayoutInflater.from(viewGroup.getContext());
        return new ViewHolder(layoutInflater.inflate(R.layout.item_icon, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        final String theme = listTheme.get(i);
        Glide.with(context).load(Uri.parse("file:///android_asset/icon/" + theme)).into(viewHolder.imTheme);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            imTheme = itemView.findViewById(R.id.imIcon);
        }
    }
